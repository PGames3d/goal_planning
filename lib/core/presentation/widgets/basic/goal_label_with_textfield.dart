...
class GoalLabelWithTextFormField extends FormField<String> {
  GoalLabelWithTextFormField(
      {super.key,
      this.heightOfField,
      this.maxLines,
...
class _TextFormFieldState extends FormFieldState<String> {
  ...
  GoalLabelWithTextFormField get _textFormField =>
      super.widget as GoalLabelWithTextFormField;
  ...
  @override
  void didUpdateWidget(GoalLabelWithTextFormField oldWidget) {
