...
class GoalSimpleTextFormField extends FormField<String> {
  GoalSimpleTextFormField(
      {super.key,
      this.heightOfField,
      this.maxLines,
                        ...
                        children: [
                          GoalRichText(text: [
                            TextSpan(
                              ...
                              // style: GoalResponsive.isMobile(field.context)
                              //     ? Theme.of(field.context)
                              //         .textTheme
                              //         .titleSmall
                              //         ?.copyWith(fontWeight: FontWeight.w700)
...
class _TextFormFieldState extends FormFieldState<String> {
  ...
  GoalSimpleTextFormField get _textFormField =>
      super.widget as GoalSimpleTextFormField;
  ...
  @override
  void didUpdateWidget(GoalSimpleTextFormField oldWidget) {
