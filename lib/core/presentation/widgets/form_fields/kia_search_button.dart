...
class KiaSearchButton extends FormField<String> {
  KiaSearchButton(
      {super.key,
      this.controller,
      String? initialValue,
...
class _TextFormFieldState extends FormFieldState<String> {
  ...
  KiaSearchButton get _textFormField => super.widget as KiaSearchButton;
  ...
  @override
  void didUpdateWidget(KiaSearchButton oldWidget) {
