...
class GoalPasswordTextField extends StatefulWidget {
  const GoalPasswordTextField(
      {super.key,
      this.validator,
  ...
  @override
  State<GoalPasswordTextField> createState() =>
      _GoalPasswordTextFieldState();
}

class _GoalPasswordTextFieldState extends State<GoalPasswordTextField> {
                ...
                Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: <Widget>[
                        GoalText(widget.hintOrLabelText,
