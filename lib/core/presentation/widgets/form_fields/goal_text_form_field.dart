...
class GoalTextFormField extends FormField<String> {
  GoalTextFormField({
    super.key,
    this.controller,
    String? initialValue,
...
class _TextFormFieldState extends FormFieldState<String> {
  ...
  GoalTextFormField get _textFormField => super.widget as GoalTextFormField;
  ...
  @override
  void didUpdateWidget(GoalTextFormField oldWidget) {
