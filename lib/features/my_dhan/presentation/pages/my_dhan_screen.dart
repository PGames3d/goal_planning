...
import '../bloc/my_dhan_bloc.dart';
@RoutePage()
class MyDhanScreen extends StatefulWidget {
  const MyDhanScreen({super.key});

  @override
  State<MyDhanScreen> createState() => _MyDhanScreenState();
}

class _MyDhanScreenState extends State<MyDhanScreen> {
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  final ScrollController _customScrollController = ScrollController();
  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => MyDhanBloc(),
      child: BlocConsumer<MyDhanBloc, MyDhanState>(
